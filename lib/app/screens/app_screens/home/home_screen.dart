          ...
          child: Column(
            children: [
                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          ...
                          Text("Track Parcel", style: GoogleFonts.numans(color: Colors.white, fontSize: 20, fontWeight: FontWeight.bold)),
                      ...
                      Container(
                        ...
                        child: Obx(() => TextField(
                          ...
                          style: GoogleFonts.numans(color: Colors.black87, fontSize: 16),
                          decoration: InputDecoration(
                            contentPadding: const EdgeInsets.only(top: 14),
                            border: InputBorder.none,
                            hintText: 'Enter Tracker ID...',
                            hintStyle: TextStyle(color: Colors.grey.shade500),
                            prefixIcon: const Icon(Icons.track_changes, color: Colors.blueAccent),
                            suffixIcon: GestureDetector(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                    color: firebaseController.isSearchPerformed.value ? Colors.red.withOpacity(0.1) : Colors.blue.withOpacity(0.1),
                                    borderRadius: BorderRadius.circular(10)
                                ),
                                child: Icon(
                                  firebaseController.isSearchPerformed.value ? Icons.close : CupertinoIcons.search,
                                  color: firebaseController.isSearchPerformed.value ? Colors.redAccent : Colors.blueAccent,
                                  size: 20,
                                ),
                              ),
                            ),
              ...
              Padding(
                ...
                child: Obx(() {
                  if (firebaseController.isLoading.value) return const Center(child: SpinKitCircle(color: Colors.blueAccent, size: 40.0));
                    ...
                    return Center(
                        child: Column(
                          children: [
                            ...
                            Text("Search for a parcel ID\nto view tracking status.", textAlign: TextAlign.center, style: GoogleFonts.numans(
                  ...
                  return Container(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          InfoRow(Icons.person_outline, "Sender", "${data['sender_name']}"),
                          InfoRow(Icons.my_location, "Pick up", "${data['sender_address']}"),
                          const Padding(padding: EdgeInsets.symmetric(vertical: 8), child: Divider(color: Color(0xFFEEEEEE))),
                          InfoRow(Icons.person_pin_circle_outlined, "Receiver", "${data['receiver_name']}"),
                          InfoRow(Icons.location_on_outlined, "Drop", "${data['receiver_address']}"),
                          ...
                          Row(
                            children: [
                              Container(
                                  ...
                                  child: const Icon(Icons.timeline, color: Colors.blueAccent, size: 18)
                              ),
                              ...
                              if (status != "pending" && status != "received at warehouse")
                                GestureDetector(
                                  onTap: () => firebaseController.makePhoneCall(data['rider_phone'] ?? ""),
                                  child: Container(
                          ...
                          TrackStep(
                              ...
                              status == "delivery to rider" || status == "handed over to rider" || status == "delivered" || status == "delivery complete",
                              isLast: false),
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          const SizedBox(width: 8),
          Expanded(
            child: RichText(text: TextSpan(style: GoogleFonts.numans(color: Colors.black87, fontSize: 14),
                children: [
        ...
        children: [
          Column(
            children: [
              Container(
                ...
                child: Icon(Icons.check, color: isDone ? Colors.white : Colors.transparent, size: 12),
              ),
              if (!isLast)
                Expanded(
                  child: Container(
          ...
          Expanded(
            child: Padding(
              ...
              child: Text(title, style: GoogleFonts.numans(
                  fontSize: 14,
